...
--
-- Host: localhost
-- Generation Time: Sep 01, 2017 at 03:12 
...
(20, 'Parrainage', 11, 'Le club FACE Territoire Bourbonnais est animateur de son réseau de parrainage. Il mobilise ses adhérents, les entreprises du territoire, les partenaires emploi et insertion en contact avec le public et contractualise les partenariat.\r\n<h6>FACE TERRITOIRE BOURBONNAIS :</h6>\r\n<ul>\r\n<li>\r\nIdentifie, sélectionne et accompagne les personnes à parrainer (les filleuls);\r\n</li>\r\n<li>\r\nInforme, forme et conseille les parrains afin de mieux les accompagner dans leur mission;\r\n</li>\r\n<li>\r\nFormalise les engagements entre parrains et les filleuls;\r\n</li>\r\n<li>\r\nAssure la coordination, la médiation, le suivi et l\'évaluation de l\'action;\r\n</li>\r\n<li>\r\nRéunit les parrains pour échanger sur l\'accompagnement à l\'emploi;\r\n</li>\r\n<li>Entraine les filleuls au différentes techniques de recherche d\'emploi en les testant auprès de prefessionnels;</li>\r\n<li>Accompagne les filleuls lors de leurs premiers pas en entreprise;</li>\r\n</ul>\r\n', '', '', 'FACE Territoire Bourbonnais lance un accompagnement individuel pour faciliter l\'accès à l\'emploi durable.', '');
